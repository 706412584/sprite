...
public static class JungleAdventure2DScreen
{
    ...
    public static LayoutScreenResult Build(Action<string>? onAction = null)
    {
        ...
        gamescene2d_ztj183re.Background = new SolidColorBrush(Color.FromArgb(255, 12, 26, 46)); // 不透明背景遮挡3D
        // 2D 场景: 星火2.0 使用 CanvasAnimated + 简单AABB物理
        // SceneGraph 会导致原生崩溃（延迟渲染），用CanvasAnimated 即时渲染
        ...
        gradientblock_mwjzd5fu.Visible = false; // 隐藏，由主Canvas中绘制
        var image_i0rdvtg5 = LayoutEditorSpark2Runtime.Register(nodes, "image_i0rdvtg5", LayoutEditorSpark2Runtime.CreateImageCard("image_i0rdvtg5", LayoutEditorSpark2Runtime.Asset("image/game2d/sheets/mossy_hills.png"), 960f, 540f, LayoutEditorSpark2Runtime.Color(80, 16, 16, 18), 8f));
        ...
        image_i0rdvtg5.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        spriteanimation_ys7k64aa.Margin = new Thickness(10f, 420f, 0f, 0f);
        spriteanimation_ys7k64aa.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        {
            ImageAsset = LayoutEditorSpark2Runtime.Asset("image/game2d/sheets/plant1.png"),
            FrameWidth = 512,
            FrameHeight = 512,
            FrameCount = 90,
            FramesPerRow = 10,
        ...
        spriteanimation_5lcymdot.Margin = new Thickness(200f, 440f, 0f, 0f);
        spriteanimation_5lcymdot.Visible = false; // 隐藏，由主Canvas中绘制
        // 帧动画: 使用 AnimatedImageSource 在 Canvas 上绘制
        // 需要在数据编辑器中定义 GameDataAnimatedImage 资源
        ...
        spriteanimation_5llm3r4r.Margin = new Thickness(480f, 430f, 0f, 0f);
        spriteanimation_5llm3r4r.Visible = false; // 隐藏，由主Canvas中绘制
        // 帧动画: 使用 AnimatedImageSource 在 Canvas 上绘制
        // 需要在数据编辑器中定义 GameDataAnimatedImage 资源
        LayoutEditorSpark2Runtime.ConfigureSpriteAnimation(spriteanimation_5llm3r4r, new SpriteAnimationConfig
        {
            ImageAsset = LayoutEditorSpark2Runtime.Asset("image/game2d/sheets/plant_poison.png"),
            FrameWidth = 512,
            FrameHeight = 512,
            FrameCount = 30,
            FramesPerRow = 10,
        ...
        spriteanimation_y2x5fomx.Margin = new Thickness(850f, 450f, 0f, 0f);
        spriteanimation_y2x5fomx.Visible = false; // 隐藏，由主Canvas中绘制
        // 帧动画: 使用 AnimatedImageSource 在 Canvas 上绘制
        // 需要在数据编辑器中定义 GameDataAnimatedImage 资源
        ...
        spriteanimation_m6mj18dd.Margin = new Thickness(680f, 440f, 0f, 0f);
        spriteanimation_m6mj18dd.Visible = false; // 隐藏，由主Canvas中绘制
        // 帧动画: 使用 AnimatedImageSource 在 Canvas 上绘制
        // 需要在数据编辑器中定义 GameDataAnimatedImage 资源
        ...
        collider2d_zypn0bay.Margin = new Thickness(0f, 500f, 0f, 0f);
        collider2d_zypn0bay.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        shaperect_9bvxln2x.Margin = new Thickness(0f, 500f, 0f, 0f);
        shaperect_9bvxln2x.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        shapeline_g7jeu764.Margin = new Thickness(0f, 498f, 0f, 0f);
        shapeline_g7jeu764.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        collider2d_m1a21kdw.Margin = new Thickness(120f, 390f, 0f, 0f);
        collider2d_m1a21kdw.Visible = false; // 隐藏，由主Canvas中绘制
        // 碰撞体: RigidBody2D(Static) + CollisionBox2D
        ...
        shaperect_ei19bp0i.Margin = new Thickness(120f, 390f, 0f, 0f);
        shaperect_ei19bp0i.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        collider2d_48uj6zky.Margin = new Thickness(380f, 310f, 0f, 0f);
        collider2d_48uj6zky.Visible = false; // 隐藏，由主Canvas中绘制
        // 碰撞体: RigidBody2D(Static) + CollisionBox2D
        ...
        shaperect_k0cgbwn3.Margin = new Thickness(380f, 310f, 0f, 0f);
        shaperect_k0cgbwn3.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        collider2d_3w390iej.Margin = new Thickness(620f, 240f, 0f, 0f);
        collider2d_3w390iej.Visible = false; // 隐藏，由主Canvas中绘制
        // 碰撞体: RigidBody2D(Static) + CollisionBox2D
        ...
        shaperect_nuf5zzj0.Margin = new Thickness(620f, 240f, 0f, 0f);
        shaperect_nuf5zzj0.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        collider2d_9m8ogd4r.Margin = new Thickness(800f, 370f, 0f, 0f);
        collider2d_9m8ogd4r.Visible = false; // 隐藏，由主Canvas中绘制
        // 碰撞体: RigidBody2D(Static) + CollisionBox2D
        ...
        shaperect_9kb47ul0.Margin = new Thickness(800f, 370f, 0f, 0f);
        shaperect_9kb47ul0.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        spriteanimation_6g23g0o8.Margin = new Thickness(300f, 442f, 0f, 0f);
        spriteanimation_6g23g0o8.Visible = false; // 隐藏，由主Canvas中绘制
        // 帧动画: 使用 AnimatedImageSource 在 Canvas 上绘制
        // 需要在数据编辑器中定义 GameDataAnimatedImage 资源
        LayoutEditorSpark2Runtime.ConfigureSpriteAnimation(spriteanimation_6g23g0o8, new SpriteAnimationConfig
        {
            ImageAsset = LayoutEditorSpark2Runtime.Asset("image/game2d/sheets/slime_orange.png"),
            FrameWidth = 510,
            FrameHeight = 410,
            FrameCount = 30,
            FramesPerRow = 10,
        ...
        collider2d_ex6ai4yz.Margin = new Thickness(306f, 447f, 0f, 0f);
        collider2d_ex6ai4yz.Visible = false; // 隐藏，由主Canvas中绘制
        // 碰撞体: RigidBody2D(Static) + CollisionBox2D
        ...
        spriteanimation_9m1aubjh.Margin = new Thickness(540f, 456f, 0f, 0f);
        spriteanimation_9m1aubjh.Visible = false; // 隐藏，由主Canvas中绘制
        // 帧动画: 使用 AnimatedImageSource 在 Canvas 上绘制
        // 需要在数据编辑器中定义 GameDataAnimatedImage 资源
        LayoutEditorSpark2Runtime.ConfigureSpriteAnimation(spriteanimation_9m1aubjh, new SpriteAnimationConfig
        {
            ImageAsset = LayoutEditorSpark2Runtime.Asset("image/game2d/sheets/slime_green.png"),
            FrameWidth = 376,
            FrameHeight = 256,
            FrameCount = 30,
            FramesPerRow = 10,
        ...
        collider2d_sqwpkl9x.Margin = new Thickness(546f, 460f, 0f, 0f);
        collider2d_sqwpkl9x.Visible = false; // 隐藏，由主Canvas中绘制
        // 碰撞体: RigidBody2D(Static) + CollisionBox2D
        ...
        spriteanimation_ehzwzr2b.Margin = new Thickness(660f, 195f, 0f, 0f);
        spriteanimation_ehzwzr2b.Visible = false; // 隐藏，由主Canvas中绘制
        // 帧动画: 使用 AnimatedImageSource 在 Canvas 上绘制
        // 需要在数据编辑器中定义 GameDataAnimatedImage 资源
        ...
        collider2d_ehc99f42.Margin = new Thickness(666f, 200f, 0f, 0f);
        collider2d_ehc99f42.Visible = false; // 隐藏，由主Canvas中绘制
        // 碰撞体: RigidBody2D(Static) + CollisionBox2D
        ...
        charactercontroller2d_pgrzbdex.Margin = new Thickness(60f, 404f, 0f, 0f);
        charactercontroller2d_pgrzbdex.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        spriteanimation_wuq4e93w.Margin = new Thickness(140f, 420f, 0f, 0f);
        spriteanimation_wuq4e93w.Visible = false; // 隐藏，由主Canvas中绘制
        // 帧动画: 使用 AnimatedImageSource 在 Canvas 上绘制
        // 需要在数据编辑器中定义 GameDataAnimatedImage 资源
        LayoutEditorSpark2Runtime.ConfigureSpriteAnimation(spriteanimation_wuq4e93w, new SpriteAnimationConfig
        {
            ImageAsset = LayoutEditorSpark2Runtime.Asset("image/game2d/sheets/wizard_dash_fx.png"),
            FrameWidth = 512,
            FrameHeight = 512,
            FrameCount = 16,
            FramesPerRow = 8,
        ...
        joystick_ola1xd6b.Margin = new Thickness(20f, 420f, 0f, 0f);
        joystick_ola1xd6b.Visible = false; // 隐藏，由主Canvas中绘制
        ...
        text_rmoicp1q.Margin = new Thickness(16f, 12f, 0f, 0f);
        ...
        text_78rdu92p.Margin = new Thickness(0f, 12f, 16f, 0f);
        ...
        text_8ngu0ok6.Margin = new Thickness(0f, 12f, 0f, 0f);
    ...
    public static IReadOnlyList<string> ExportNotes()
    {
        return new string[]
        {
            ...
            "Node spriteanimation_ys7k64aa binds image resource image/game2d/sheets/plant1.png; Spark2 export now writes it to the control Image property.",
            "SpriteAnimation spriteanimation_5lcymdot: 星火2.0使用 AnimatedImageSource + CanvasAnimated 绘制帧动画。需在数据编辑器中创建 GameDataAnimatedImage 资源（Image=image/game2d/sheets/plant1.png, FramesPerRow=10, 帧数=90）。Canvas.DrawAnimatedImage(anim, x, y) 进行渲染。",
            "Node spriteanimation_5lcymdot binds image resource image/game2d/sheets/plant1.png; Spark2 export now writes it to the control Image property.",
            "SpriteAnimation spriteanimation_5llm3r4r: 星火2.0使用 AnimatedImageSource + CanvasAnimated 绘制帧动画。需在数据编辑器中创建 GameDataAnimatedImage 资源（Image=image/game2d/sheets/plant_poison.png, FramesPerRow=10, 帧数=30）。Canvas.DrawAnimatedImage(anim, x, y) 进行渲染。",
            "Node spriteanimation_5llm3r4r binds image resource image/game2d/sheets/plant_poison.png; Spark2 export now writes it to the control Image property.",
            "SpriteAnimation spriteanimation_y2x5fomx: 星火2.0使用 AnimatedImageSource + CanvasAnimated 绘制帧动画。需在数据编辑器中创建 GameDataAnimatedImage 资源（Image=image/game2d/sheets/plant1.png, FramesPerRow=10, 帧数=90）。Canvas.DrawAnimatedImage(anim, x, y) 进行渲染。",
            "Node spriteanimation_y2x5fomx binds image resource image/game2d/sheets/plant1.png; Spark2 export now writes it to the control Image property.",
            "SpriteAnimation spriteanimation_m6mj18dd: 星火2.0使用 AnimatedImageSource + CanvasAnimated 绘制帧动画。需在数据编辑器中创建 GameDataAnimatedImage 资源（Image=image/game2d/sheets/plant_poison.png, FramesPerRow=10, 帧数=30）。Canvas.DrawAnimatedImage(anim, x, y) 进行渲染。",
            "Node spriteanimation_m6mj18dd binds image resource image/game2d/sheets/plant_poison.png; Spark2 export now writes it to the control Image property.",
            ...
            "SpriteAnimation spriteanimation_6g23g0o8: 星火2.0使用 AnimatedImageSource + CanvasAnimated 绘制帧动画。需在数据编辑器中创建 GameDataAnimatedImage 资源（Image=image/game2d/sheets/slime_orange.png, FramesPerRow=10, 帧数=30）。Canvas.DrawAnimatedImage(anim, x, y) 进行渲染。",
            "Node spriteanimation_6g23g0o8 binds image resource image/game2d/sheets/slime_orange.png; Spark2 export now writes it to the control Image property.",
            "Collider2D collider2d_ex6ai4yz: 星火2.0使用 RigidBody2D(Static) + CollisionBox2D。IsTrigger=true(触发器不阻挡物理)。tag=enemy。",
            "SpriteAnimation spriteanimation_9m1aubjh: 星火2.0使用 AnimatedImageSource + CanvasAnimated 绘制帧动画。需在数据编辑器中创建 GameDataAnimatedImage 资源（Image=image/game2d/sheets/slime_green.png, FramesPerRow=10, 帧数=30）。Canvas.DrawAnimatedImage(anim, x, y) 进行渲染。",
            "Node spriteanimation_9m1aubjh binds image resource image/game2d/sheets/slime_green.png; Spark2 export now writes it to the control Image property.",
            "Collider2D collider2d_sqwpkl9x: 星火2.0使用 RigidBody2D(Static) + CollisionBox2D。IsTrigger=true(触发器不阻挡物理)。tag=enemy。",
            "SpriteAnimation spriteanimation_ehzwzr2b: 星火2.0使用 AnimatedImageSource + CanvasAnimated 绘制帧动画。需在数据编辑器中创建 GameDataAnimatedImage 资源（Image=image/game2d/sheets/slime_orange.png, FramesPerRow=10, 帧数=30）。Canvas.DrawAnimatedImage(anim, x, y) 进行渲染。",
            "Node spriteanimation_ehzwzr2b binds image resource image/game2d/sheets/slime_orange.png; Spark2 export now writes it to the control Image property.",
            ...
            "SpriteAnimation spriteanimation_wuq4e93w: 星火2.0使用 AnimatedImageSource + CanvasAnimated 绘制帧动画。需在数据编辑器中创建 GameDataAnimatedImage 资源（Image=image/game2d/sheets/wizard_dash_fx.png, FramesPerRow=8, 帧数=16）。Canvas.DrawAnimatedImage(anim, x, y) 进行渲染。",
            "Node spriteanimation_wuq4e93w binds image resource image/game2d/sheets/wizard_dash_fx.png; Spark2 export now writes it to the control Image property.",
