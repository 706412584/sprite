...
export const skeletonTemplates: SkeletonTemplate[] = [
  ...
  {
    id: "humanoid_side_detailed",
    label: "人形侧面细分",
    description: "适合真侧面 PSD：近/远侧四肢、头发、五官、手脚和衣摆骨骼。",
    bones: [
      { name: "root", displayName: "root_根", parent: null, x: 0, y: 0 },
      { name: "torso", displayName: "torso_侧身躯干", parent: "root", x: 0, y: 0, rotation: -90, length: 120 },
      { name: "chest", displayName: "chest_胸腔", parent: "torso", x: 80, y: 0, length: 36 },
      { name: "waist", displayName: "waist_腰部", parent: "torso", x: 16, y: 0, length: 28 },
      { name: "cape", displayName: "cape_背饰", parent: "chest", x: 10, y: 0, rotation: 90, length: 70 },
      { name: "skirt", displayName: "skirt_衣摆", parent: "waist", x: 0, y: 0, rotation: 90, length: 55 },
      { name: "head", displayName: "head_侧脸", parent: "torso", x: 130, y: 0, length: 60 },
      { name: "hairBack", displayName: "hairBack_后发", parent: "head", x: 6, y: -5, rotation: 90, length: 45 },
      { name: "hairFront", displayName: "hairFront_前发", parent: "head", x: -4, y: 6, rotation: 90, length: 38 },
      { name: "eyeL", displayName: "eyeL_近侧眼", parent: "head", x: 0, y: 10, length: 12 },
      { name: "eyeR", displayName: "eyeR_远侧眼", parent: "head", x: 0, y: -8, length: 10 },
      { name: "mouth", displayName: "mouth_嘴巴", parent: "head", x: 16, y: 0, length: 12 },
      { name: "upperArmL", displayName: "upperArmL_近侧大臂", parent: "torso", x: 88, y: 24, rotation: 95, length: 70 },
      { name: "forearmL", displayName: "forearmL_近侧前臂", parent: "upperArmL", x: 70, y: 0, length: 60 },
      { name: "handL", displayName: "handL_近侧手", parent: "forearmL", x: 60, y: 0, length: 22 },
      { name: "upperArmR", displayName: "upperArmR_远侧大臂", parent: "torso", x: 88, y: -18, rotation: 102, length: 66 },
      { name: "forearmR", displayName: "forearmR_远侧前臂", parent: "upperArmR", x: 66, y: 0, length: 56 },
      { name: "handR", displayName: "handR_远侧手", parent: "forearmR", x: 56, y: 0, length: 20 },
      { name: "thighL", displayName: "thighL_近侧大腿", parent: "root", x: 0, y: 14, rotation: 92, length: 90 },
      { name: "shinL", displayName: "shinL_近侧小腿", parent: "thighL", x: 90, y: 0, length: 90 },
      { name: "footL", displayName: "footL_近侧脚", parent: "shinL", x: 90, y: 0, length: 28 },
      { name: "thighR", displayName: "thighR_远侧大腿", parent: "root", x: 0, y: -12, rotation: 88, length: 86 },
      { name: "shinR", displayName: "shinR_远侧小腿", parent: "thighR", x: 86, y: 0, length: 84 },
      { name: "footR", displayName: "footR_远侧脚", parent: "shinR", x: 84, y: 0, length: 24 },
    ],
    slots: [
      { name: "hairBack", displayName: "hairBack_后发", bone: "hairBack", zOrder: 20, hint: "后发 / 远侧头饰", defaultPivot: { x: 0.5, y: 0.2 } },
      { name: "cape", displayName: "cape_背饰", bone: "cape", zOrder: 24, hint: "披风 / 背饰", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "thighR", displayName: "thighR_远侧大腿", bone: "thighR", zOrder: 30, hint: "远侧大腿", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "shinR", displayName: "shinR_远侧小腿", bone: "shinR", zOrder: 31, hint: "远侧小腿", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "footR", displayName: "footR_远侧脚", bone: "footR", zOrder: 32, hint: "远侧脚 / 鞋", defaultPivot: { x: 0.3, y: 0.5 } },
      { name: "upperArmR", displayName: "upperArmR_远侧大臂", bone: "upperArmR", zOrder: 36, hint: "远侧大臂", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "forearmR", displayName: "forearmR_远侧前臂", bone: "forearmR", zOrder: 37, hint: "远侧前臂", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "handR", displayName: "handR_远侧手", bone: "handR", zOrder: 38, hint: "远侧手", defaultPivot: { x: 0.3, y: 0.5 } },
      { name: "torso", displayName: "torso_侧身躯干", bone: "torso", zOrder: 50, hint: "侧身躯干", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "waist", displayName: "waist_腰部", bone: "waist", zOrder: 52, hint: "腰带 / 下装", defaultPivot: { x: 0.5, y: 0.2 } },
      { name: "chest", displayName: "chest_胸腔", bone: "chest", zOrder: 54, hint: "上衣 / 胸甲", defaultPivot: { x: 0.5, y: 0.2 } },
      { name: "skirt", displayName: "skirt_衣摆", bone: "skirt", zOrder: 56, hint: "衣摆", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "thighL", displayName: "thighL_近侧大腿", bone: "thighL", zOrder: 60, hint: "近侧大腿", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "shinL", displayName: "shinL_近侧小腿", bone: "shinL", zOrder: 61, hint: "近侧小腿", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "footL", displayName: "footL_近侧脚", bone: "footL", zOrder: 62, hint: "近侧脚 / 鞋", defaultPivot: { x: 0.3, y: 0.5 } },
      { name: "upperArmL", displayName: "upperArmL_近侧大臂", bone: "upperArmL", zOrder: 66, hint: "近侧大臂", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "forearmL", displayName: "forearmL_近侧前臂", bone: "forearmL", zOrder: 67, hint: "近侧前臂", defaultPivot: { x: 0.5, y: 0.1 } },
      { name: "handL", displayName: "handL_近侧手", bone: "handL", zOrder: 68, hint: "近侧手 / 持物", defaultPivot: { x: 0.3, y: 0.5 } },
      { name: "head", displayName: "head_侧脸", bone: "head", zOrder: 80, hint: "侧脸 / 头部", defaultPivot: { x: 0.5, y: 0.85 } },
      { name: "eyeL", displayName: "eyeL_近侧眼", bone: "eyeL", zOrder: 84, hint: "近侧眼", defaultPivot: { x: 0.5, y: 0.5 } },
      { name: "eyeR", displayName: "eyeR_远侧眼", bone: "eyeR", zOrder: 85, hint: "远侧眼（可选）", defaultPivot: { x: 0.5, y: 0.5 } },
      { name: "mouth", displayName: "mouth_嘴巴", bone: "mouth", zOrder: 86, hint: "嘴巴 / 表情", defaultPivot: { x: 0.5, y: 0.5 } },
      { name: "hairFront", displayName: "hairFront_前发", bone: "hairFront", zOrder: 90, hint: "前发 / 刘海", defaultPivot: { x: 0.5, y: 0.2 } },
    ],
  },
  {
    id: "quadruped",
